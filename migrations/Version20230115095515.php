 ...
 */
final class Version20230115095515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE resource_like ADD CONSTRAINT FK_A343E00989329D25 FOREIGN KEY (resource_id) REFERENCES resource (id)');
        $this->addSql('ALTER TABLE resource_like ADD CONSTRAINT FK_A343E009A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
