 ...
 */
final class Version20230123104223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE resource_consult ADD CONSTRAINT FK_10A22E0A89329D25 FOREIGN KEY (resource_id) REFERENCES resource (id)');
        $this->addSql('ALTER TABLE resource_consult ADD CONSTRAINT FK_10A22E0AA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
