 ...
 */
final class Version20221224161007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD state_id INT NOT NULL, CHANGE birth_date birth_date DATE NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP state_id, CHANGE birth_date birth_date DATE DEFAULT NULL');
    }
}
