 ...
 */
final class Version20230114103401 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE resource_shared_visibilities (resource_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_E5167D6789329D25 (resource_id), INDEX IDX_E5167D67A76ED395 (user_id), PRIMARY KEY(resource_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
