 ...
 */
final class Version20230123101741 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE resource_share ADD CONSTRAINT FK_C4BDE76889329D25 FOREIGN KEY (resource_id) REFERENCES resource (id)');
        $this->addSql('ALTER TABLE resource_share ADD CONSTRAINT FK_C4BDE768A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
