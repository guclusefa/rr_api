 ...
 */
final class Version20230115095609 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE resource_categories (resource_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_5AEB01EE12469DE2 (category_id), INDEX IDX_5AEB01EE89329D25 (resource_id), PRIMARY KEY(resource_id, category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
