 ...
 */
final class Version20230123131522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE resource_shared_to ADD CONSTRAINT FK_FBE3D96B89329D25 FOREIGN KEY (resource_id) REFERENCES resource (id)');
        $this->addSql('ALTER TABLE resource_shared_to ADD CONSTRAINT FK_FBE3D96BA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
